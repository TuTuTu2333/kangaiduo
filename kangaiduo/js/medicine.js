$(() => {
    ...
    function renderUI(data, index) {
        ...
        $(".YproList2 ul li div").each(function () {
            $(this).click(function () {
                ...
                window.location.href = `http://127.0.0.1/H51913/myProject1/kangaiduo/html/shopParticulars.html?id=${id}&table=druglistpage`;
            })
        })
    }
    ...
    $("#fixeNav").load("../html/fixed_navigation.html .fixed_navigation", function () {
